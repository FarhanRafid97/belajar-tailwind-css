...
const Home = () => {
  return (
    <div className="home  bg-gray-100 dark:bg-gray-800 dark:text-white ease-in duration-200">
      <div className="container h-screen flex items-end ">
        <div className="section  bg-gray-100 dark:bg-gray-800 ease-in duration-200 mb-5 ">
